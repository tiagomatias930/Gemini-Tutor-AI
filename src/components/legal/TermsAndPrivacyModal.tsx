...
import { ShieldCheck, MapPin, Cpu, HardDrive, Check, X, Lock, Eye, AlertCircle, ChevronRight } from 'lucide-react';
import { useTheme } from '../../contexts/ThemeContext';
import { ConsentPreferences, getConsentPreferences, saveConsentPreferences } from '../../utils/telemetryClient';
        ...
        >
          ...
          <div className="p-3 sm:p-4 pb-2 border-b" style={{ borderColor: c.border }}>
            ...
            <p className="text-xs sm:text-sm mt-4 leading-relaxed" style={{ color: c.textMuted }}>
              Para garantir uma experiência de ensino estável, acessível e segura, o <strong>Ngola Tutor AI</strong> coleta métricas operacionais e oferece armazenamento em cache local. Abaixo detalhamos como os seus dados são tratados com responsabilidade ética.
            </p>
          </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h4 className="font-heading font-bold text-sm" style={{ color: c.text }}>
                      1. Acesso à Localização e Endereço IP
                    </h4>
                    <p className="text-xs leading-relaxed mt-1" style={{ color: c.textMuted }}>
                      Monitoramos o endereço IP e a localização geográfica aproximada (País e Cidade) para roteamento de servidores de baixa latência, geração de mapas agregados de impacto regional e prevenção contra ataques cibernéticos.
                    </p>
                  </div>
                </div>
            ...
            >
              <div className="flex items-start justify-between gap-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h4 className="font-heading font-bold text-sm" style={{ color: c.text }}>
                      2. Telemetria de KPIs, Tokens & Tempo de Uso
                    </h4>
                    <p className="text-xs leading-relaxed mt-1" style={{ color: c.textMuted }}>
                      Acompanhamos métricas de desempenho: quantidade de tokens de IA processados, duração da sessão de mentoria, taxa de sucesso das requisições e latência da rede, garantindo a estabilidade e auditoria do serviço público.
                    </p>
                  </div>
                </div>
            ...
            >
              <div className="flex items-start justify-between gap-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h4 className="font-heading font-bold text-sm" style={{ color: c.text }}>
                      3. Permissão de Cache Local (Proteção contra Quedas de Internet)
                    </h4>
                    <p className="text-xs leading-relaxed mt-1" style={{ color: c.textMuted }}>
                      Solicitamos a autorização para salvar suas conversas, histórico de tarefas e diagramas no cache local seguro do seu navegador. Dessa forma, caso a sua conexão oscile ou caia, o seu progresso não será perdido.
                    </p>
                  </div>
                </div>
